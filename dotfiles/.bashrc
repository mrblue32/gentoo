...
alias wpa_start='doas wpa_supplicant -B -i wlan0 -c /etc/wpa_supplicant/wpa_supplicant.conf && doas wpa_cli enable_network 1'
alias packages='neofetch packages | grep -Eo "[0-9].*[0-9]"'
alias lf='lf-ueberzug /home/lumi/'
alias dmci='doas make clean install'
alias paranoia='echo "This file will be DELETED! Proceed?" ; read $ans && doas shred -n 5 -fzvu'
alias wrt='cat << EOF >'
...
alias pwr='doas openrc-shutdown --poweroff now'
...
#PS1='\u.\H:/\W > '
#PS1='❯❯❯ '
PS1=$prompt_color'[\W] \[\033[0;32m\]❯❯❯ \[\033[0m\]'
unset prompt_color
